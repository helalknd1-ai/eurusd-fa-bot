...
# ==================================================================
ECON_RULES = """قوانین اقتصادی EUR/USD (حتماً و دقیقاً رعایت کن):

۱. نفت:
- اروپا واردکننده خالص نفت است
- نفت ارزان = سود اروپا = صعودی یورو/دلار
- نفت گران = ضرر اروپا = نزولی یورو/دلار
...
- هیچ‌گاه نگوی تورم کاهشی باعث افزایش نرخ می‌شود

۳. تورم اروپا:
- تورم اروپا بالا = بانک مرکزی اروپا سخت‌گیرانه = یورو قوی = صعودی
- تورم اروپا پایین = بانک مرکزی اروپا ملایم = یورو ضعیف = نزولی

۴. داده‌های اقتصادی آمریکا:
- داده قوی (اشتغال قوی، رشد بالا، فروش قوی) = دلار قوی = نزولی یورو
- داده ضعیف = دلار ضعیف = صعودی یورو
- بیکاری بالاتر از انتظار = دلار ضعیف = صعودی یورو
...
۷. شاخص دلار (DXY):
- DXY بالا = دلار قوی = نزولی یورو
- DXY پایین = دلار ضعیف = صعودی یورو

۸. بازده اوراق قرضه آمریکا:
- بازده بالا = دلار قوی = نزولی یورو
- بازده پایین = دلار ضعیف = صعودی یورو

۹. طلا:
- طلا بالا = دلار ضعیف = صعودی یورو
- طلا پایین = دلار قوی = نزولی یورو

۱۰. احساسات ریسک بازار:
- ریسک‌پذیری بالا = دلار ضعیف = صعودی یورو
- ریسک‌گریزی = دلار پناهگاه امن = دلار قوی = نزولی یورو

۱۱. بحران ژئوپلیتیک:
- جنگ، تنش، حمله = دلار پناهگاه امن = دلار قوی = نزولی یورو
- بحران حل شود = دلار ضعیف = صعودی یورو

۱۲. رشد اقتصادی:
- رشد قوی آمریکا = دلار قوی = نزولی یورو
- رشد قوی اروپا = یورو قوی = صعودی
- رشد ضعیف آمریکا = دلار ضعیف = صعودی یورو

۱۳. تفاوت نرخ آمریکا و اروپا:
- نرخ آمریکا بالاتر از اروپا = دلار قوی = نزولی یورو
- نرخ اروپا به آمریکا نزدیک یا بالاتر = یورو قوی = صعودی

۱۴. تعرفه و جنگ تجاری:
- تعرفه علیه اروپا = یورو ضعیف = نزولی
- تعرفه عمومی = دلار پناهگاه = نزولی یورو

۱۵. قانون کلیدی:
- همیشه علت و معلول را درست بگو
- هیچ‌گاه منطق اقتصادی را برعکس نکن
- جهت تحلیل باید با این قوانین هم‌خوانی داشته باشد"""
